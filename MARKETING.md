...
**EN:** An open-source macOS menu bar companion for Codex. Auto Retry safely continues capacity-interrupted tasks, with official updates and docs close at hand.

**中文：** 一个开源的 Codex macOS 菜单栏辅助工具：模型暂时满载时安全续跑原任务，并集中提供官方动态与文档入口。
...
So I built **Codex Helper**. Its first feature, Auto Retry, watches for that exact failure, waits with progressive backoff, checks that you have not already continued manually, and safely resumes the original task.
