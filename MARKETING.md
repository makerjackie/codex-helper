...
**EN:** An open-source macOS menu bar companion for Codex. Auto Retry safely continues a task when the selected model is temporarily at capacity.

**中文：** 一个开源的 Codex macOS 菜单栏辅助工具；首个功能“自动重试”会在模型暂时满载时安全续跑原任务。
